...
<?php osc_current_web_theme_path('common/head.php') ; ?>
	<link href="<?php echo osc_current_web_theme_url('css/custom.css') ; ?>" rel="stylesheet">
...
<header id="header">
	<div class="col-md-12">
			...
			<img class="col-md-12" src="<?php echo osc_current_web_theme_url('images/banner_1200x100.jpg') ; ?>" alt=""/>
  ...
  <div class="top_links">
    <div class="container">
      ...
      <?php } ?>
        ...
        <li class="first logged"> <span><?php echo sprintf(__('Hi %s', OSCLASSWIZARDS_THEME_FOLDER), osc_logged_user_name() . '!'); ?> </span> &#10072; <a href="<?php echo osc_user_dashboard_url(); ?>"><i class="fa fa-user"></i>&nbsp;
          <?php _e('My account', OSCLASSWIZARDS_THEME_FOLDER); ?>
          </a> &#10072; <a href="<?php echo osc_user_logout_url(); ?>"><i class="fa fa-sign-out"></i>&nbsp;
        ...
        <?php } else { ?>
				<li>
					...
					<div id="uLogin" data-ulogin="display=small;fields=first_name,last_name;providers=vkontakte,odnoklassniki,mailru,facebook;hidden=other;redirect_uri=http%3A%2F%2Far-studio.zz.vc%2Fsn_login.php"></div>
					<?
				...
				<li><a id="login_open" href="<?php echo osc_user_login_url(); ?>"><i class="fa fa-sign-in"></i>&nbsp;
          <?php _e('Login', OSCLASSWIZARDS_THEME_FOLDER) ; ?>
						&nbsp;| </a></li>
        <?php if(osc_user_registration_enabled()) { ?>
        <li><a href="<?php echo osc_register_account_url() ; ?>"><i class="fa fa-plus-circle"></i>&nbsp;
  ...
  <div class="main_header" id="main_header">
    <div class="container">
      ...
      <ul class="links">
		...
		osc_reset_static_pages();
        ?>
        <li> <a href="http://ar-studio.zz.vc">
