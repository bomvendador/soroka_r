			...
			<div id="Carousel" class="carousel slide">
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<div class="row">
							<div class="col-md-4"><a href="http://сумок.net" class="thumbnail" target="_blank"><img src="http://placehold.it/250x250" alt="Image" style="max-width:100%; height: 150px"></a></div>
							<div class="col-md-4"><a href="#" class="thumbnail"><img src="http://placehold.it/250x250" alt="Image" style="max-width:100%; height: 150px"></a></div>
							<div class="col-md-4"><a href="#" class="thumbnail"><img src="http://placehold.it/250x250" alt="Image" style="max-width:100%; height: 150px"></a></div>
